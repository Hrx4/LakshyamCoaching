          ...
          <tbody>
            {bannerList.map((item, index) => (
              <tr style={{border:"1px solid black", padding:5}} key={item._id} onClick={()=>{console.log(item._id)}}>
                <td style={{ border: "1px solid black", padding: 5 }}>{item.popupLink}</td>
                <td style={{ border: "1px solid black", padding: 5 }}>{item.popupImage}</td>
                ...
                <td style={{ border: "1px solid black", padding: 5 }}>
                  ...
                  <Button
                    ...
                    onClick={()=>CustomerModalOpen(
                     item._id,item.popupLink , item.popupImage
                )}
                  >
                    Update
                  </Button>
