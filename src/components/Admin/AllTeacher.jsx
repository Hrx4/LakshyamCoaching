...
const AllTeacher = () => {
    ...
    const handleContactTable = async () => {
      try {
        const response = await fetch(`${backend}super/teacher/`, {
          method: "GET",
          headers: {
    ...
    const handleDelete = async (id) => {
      try {
        const response = await fetch(`${backend}super/teacher/${id}/`, {
          method: "DELETE",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch(`${backend}super/teacher/${table._id}`, {
          method: "PUT",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
