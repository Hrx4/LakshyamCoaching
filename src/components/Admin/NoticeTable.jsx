  ...
  const CustomerModalOpen = (id , noticeTitle , noticeDetails , noticeLink) => {
    ...
    const handleDelete = async(id) =>{
        ...
        try {
          ...
          props.setNoticeList( [...props.noticeList.filter(item => item._id !== id)]);
  ...
  return (
    <>
      ...
      <tbody>
      {
        ...
        <th style={{border:"1px solid black", padding:5}}>Details</th>
          ...
          <tr style={{border:"1px solid black", padding:5}} key={item._id} onClick={()=>{console.log(item._id)}}>
              ...
              <td style={{border:"1px solid black" , padding:5}}>
                ...
                <Button variant='contained' color='success' size='small' onClick={()=>CustomerModalOpen(
                     item._id,item.noticeTitle , item.noticeDetails , item.noticeLink
                )} >
                  Update
                </Button>
              </td>
