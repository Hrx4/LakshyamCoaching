...
const SubDashBoard = (props) => {
  ...
  return (
      ...
      <div class="search-box">
        <input type="text" placeholder="Search..." style={{ width: '60%' }} value={enrollment} onChange={(e)=>setEnrollment(e.target.value)}></input>
      ...
      <div style={{ marginTop: 10 }}>
        <select className="student__field" onChange={(e)=>setClasss(e.target.value)} required style={{ height: 40 }}>
      ...
      <div style={{ marginTop: 10 }}>
        <select className="student__field" onChange={(e)=>setSubject(e.target.value)} required style={{ height: 40 }}>
