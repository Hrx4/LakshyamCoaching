...
const SubjectDetails = (props) => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`${backend}super/subject/${key}`, {
        method: "DELETE",
        headers: {
      ...
      props.setSubjectList([
        ...props.subjectList.filter((item) => item._id !== id),
      ]);
  ...
  const updateList = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${backend}super/subject/${updateId}`, {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
