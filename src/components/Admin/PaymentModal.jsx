...
const PaymentModal = ({modalOpen , setModalOpen , paymentList , setPaymentList , paymentId , lastPaidMonth,lastPaidYear}) => {
    // useEffect(() => {
    //     setModalOpen(true)
    // }, [])
              ...
              <form  onSubmit={(e)=>updateList(e)}>
                {
                  data.map((item , index)=>(
                    ...
                    <div className="form-group">
                      <label>{item}:</label>
                      <input type="checkbox" value={index} onClick={(e)=>handleCheck(e)} />
                    </div>
                    :
                    <div className="form-group">
                      <label>{item}:</label>
