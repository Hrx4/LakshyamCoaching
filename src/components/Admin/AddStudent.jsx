...
const AddStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${backend}super/student/`, {
        method: "POST",
        headers: {
      ...
      <div className="add-form">
        <form onSubmit={handleSubmit}>
          <div className="form-part">
            ...
            <div style={{ marginLeft: 40 }}>
              <label style={{ marginRight: 10, marginTop: 10 }}>Board</label>
              <br />
              <select
                className="student__field"
                value={studentBoard}
            ...
            <div style={{ marginLeft: 40 }}>
              <label style={{ marginRight: 10, marginTop: 10 }}>Email</label>
              <br />
              <input
                type="text"
                className="student__field"
          ...
          <div className="form-part">
            ...
            <div className="Guardian">
              <label style={{ marginRight: "10px", marginTop: 10 }}>Name</label>
              <br />
              <input
                type="text"
                className="student__field"
